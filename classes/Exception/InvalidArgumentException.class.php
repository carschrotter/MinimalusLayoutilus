...
namespace mnhcc\ml\classes\Exception {
    ...
    class InvalidArgumentException extends \InvalidArgumentException implements \JsonSerializable, interfaces\MNHcC, interfaces\Exception {
	...
	public function __construct($message = "", $code = 0, $previous = null) {
		...
		case self::TYPE_STRING:
		    ...
		    $message = 'Parameter mus from type "' . $message . '" in '.$function.'()';
		    break;
		default:
		    break;
	    }
