...
if(!\defined("INDEX")) die('Define constant "INDEX" befor run Programm!');
...
use mnhcc\ml\classes as classes; {
    ...
    if (!defined('MNHCC_PATH')) define("ROOT_PATH", __DIR__);
    if (!defined('ROOT_PATH')) define("NHCC_PATH", __DIR__);
    
    //die('Define constant "NHCC_PATH" and "ROOT_PATH"!' );
    foreach (['load', 'config'] as $filename) {
